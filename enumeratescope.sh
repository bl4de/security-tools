...
enumerate_domain() {
    ...
    # amass enum -active -norecursive -noalts -d $DOMAIN -o domains/$DOMAIN.amass
...
run_denumerator() {
    ...
    denumerator -f domains/final -c 200,403,500,206,405,411,415,422 --dir $1 --output __$1.log
